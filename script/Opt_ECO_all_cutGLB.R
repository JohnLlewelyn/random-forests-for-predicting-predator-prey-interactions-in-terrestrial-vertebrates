#optimise using ecomorph, many variables, and the modified global dataset (predators with < 5 interaction records removed)
...
glb <- as.data.frame(glb) #mean TSS = 0.755 in replicate(20 in opt# TSS = 0.756 in replicate(5 in opt
#mean tss
 
#save results
saveRDS(glb,"###/results/EcoAll_global_cut.RDS")
