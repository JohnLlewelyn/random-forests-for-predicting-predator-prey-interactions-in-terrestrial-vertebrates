#optimise using phylo eigenvectors, few variables, and the modified global dataset (predators with < 5 interaction records removed)
...
#cut to 5 most improtant variables (5 from predator, 5 from prey)
impV <- readRDS("###/data/keepVar_PEM_cut.RDS")
...
saveRDS(SDp,"###/results/PEM_FEW_SD_cut.RDS")
