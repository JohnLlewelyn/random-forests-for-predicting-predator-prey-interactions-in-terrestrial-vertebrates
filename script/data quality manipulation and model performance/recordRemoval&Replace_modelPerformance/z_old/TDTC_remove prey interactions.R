#Training dataset taxonomic coverage (TDTC) and performance - remove interactions for focal prey
...
#the function for removing prey
...
saveRDS(output,"###/TDTC_remove_focal_prey.rds")
