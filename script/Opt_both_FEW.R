#optimise using both types of data (ecomorph and phylo eig), few variables, and the original/full global dataset
...
impV <- readRDS("###/data/keepVar_both.RDS")
...
hpars <-readRDS("###/results/Hpars_Both_FEW.RDS")
...
saveRDS(SDp,"###/results/Both_FEW_SD.RDS")
