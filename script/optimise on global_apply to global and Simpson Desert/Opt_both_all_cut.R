#optimise using both types of data (ecomorph and phylo eig), many variables, and the modified global dataset (predators with < 5 interaction records removed)
...
#save results
saveRDS(glb,"###/results/Both_All_GLB_cut.RDS")
