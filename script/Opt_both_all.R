#optimise using both types of data (ecomorph and phylo eig), many variables, and the full/original global dataset 
# "###" indicates where filepaths need to be added
source("###/functions/opt_functions.R")
...
#save results
saveRDS(glb,"###/results/Both_All_GLB.RDS")
