#Random forest - all ecomorphological variables predictions just for native predators from Simpson Desert
...
#restrict to native species in Simpson Desert
...
saveRDS(SDall, "results/applied/SDaspplied_ecomorph_nativePreds.rds")
